...
export default function RelatoriosCategoriaPage() {
    ...
    const categoryReports = useMemo(() => {
        if (!categoria || categoria === "todos") return reports;
        return reports.filter((r) => r.category === categoria);
    }, [categoria]);
    ...
    const translateValue = (value: unknown, header: string): string => {
        ...
        if (headerLower.includes("status")) {
            const statusTranslations: Record<string, string> = {
                ...
                "EmAnaliseContrato": "Em Análise de Contrato",
                "Aprovado": "Aprovado",
                "Reprovado": "Reprovado",
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
                <div className="container mx-auto px-4 py-8 max-w-7xl">
                    ...
                    >
                        <BreadcrumbsVoltar
                            label={`Voltar para ${categoryLabels[categoria] || "relatórios"}`}
    ...
    // Mostrar cards dos relatórios da categoria
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                {/* Header */}
                ...
                >
                    <BreadcrumbsVoltar
                        label="Voltar para todos os relatórios"
                        onClick={() => router.push("/adm-estacao/relatorios")}
                        className="mb-4"
                    />
                    <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center gap-3">
                        ...
                        Relatórios - {categoryLabels[categoria] || "Todos"}
                    </h1>
                    <p className="text-gray-600 text-lg">
                        {categoryReports.length} relatório(s) disponível(is) nesta categoria
                    </p>
                </motion.div>
