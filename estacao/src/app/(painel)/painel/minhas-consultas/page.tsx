  ...
  return (
    <div className="w-full bg-gray-50 min-h-[calc(100vh-64px)]">
      <div className="max-w-7xl mx-auto flex gap-4 md:gap-8 px-4 md:px-6 py-4 md:py-8">
        <div className="hidden md:block w-[220px] lg:w-[260px] flex-shrink-0">
          <PainelSidebar active="/painel/minhas-consultas" />
        </div>
        <div
          className="flex-1 bg-[#FCFBF6] rounded-[8px] border border-[#E3E6E8] p-4 md:p-6 min-h-[600px] md:min-h-[904px] gap-6 flex flex-col"
