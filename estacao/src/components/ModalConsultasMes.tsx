...
interface ModalConsultasMesProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ModalConsultasMes({ isOpen, onClose }: ModalConsultasMesProps) {
  ...
  const [filtroStatus, setFiltroStatus] = useState<"todos" | "efetuada" | "cancelada">("efetuada");
  ...
  const fetchConsultas = useCallback(async () => {
    ...
    try {
      ...
      const dataInicialFinal = dataInicial || primeiroDiaMes.toISOString().split('T')[0];
      const dataFinalFinal = dataFinal || ultimoDiaMes.toISOString().split('T')[0];
  ...
  }, [filtroStatus, buscaPaciente, dataInicial, dataFinal, page]);

  useEffect(() => {
    if (isOpen) {
      setPage(1); // Reset para primeira página quando abrir
      fetchConsultas();
    }
  ...
  }, [page, filtroStatus, buscaPaciente, dataInicial, dataFinal, isOpen, fetchConsultas]);

  const handleLimparFiltros = () => {
    setBuscaPaciente("");
    setFiltroStatus("efetuada");
    setDataInicial("");
    setDataFinal("");
    setPage(1);
  };
            ...
            >
              ...
              <div className="flex items-center px-6 py-4 border-b border-[#E3E4F3] rounded-t-2xl bg-[#232A5C] relative">
                <div className="flex-1 flex justify-center">
                  <h2 className="text-lg font-bold text-white">Consultas do mês</h2>
                </div>
                <button
                  onClick={onClose}
                ...
                <div className="p-6 border-b border-gray-200 bg-gray-50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <select
                        value={filtroStatus}
                        onChange={(e) => setFiltroStatus(e.target.value as "todos" | "efetuada" | "cancelada")}
